...
const DrawVolcanoOnboardingAnimation = () => {
...
.section-banner-sun {
  ...
  background-position: center center; /* було left */
  bottom: 5px;
  right: 5px;
  border-radius: 50%;
  animation:
...
<div class="section-banner-sun">
  ...
  return (
    <View style={{
      ...
      overflow: 'hidden', // важливо для обрізки
      borderRadius: 50,   // щоб був круг
    }}>
      <WebView
        source={{ html: htmlContent.replace('height: 300px;', 'height: 100px;').replace('width: 300px;', 'width: 100px;') }}
        style={{
          width: 100,
          height: 100,
          backgroundColor: 'transparent',
...
export default DrawVolcanoOnboardingAnimation;