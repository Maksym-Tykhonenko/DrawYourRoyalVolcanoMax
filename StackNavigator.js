import DrawYourRoyalVolcanoOnboarding from './src/screens/DrawYourRoyalVolcanoOnboarding';
import DrawYourRoyalVolcanoLoad from './src/screens/DrawYourRoyalVolcanoLoad';
import { SafeAreaProvider } from 'react-native-safe-area-context';
import DrawYourRoyalVolcanoHome from './src/screens/DrawYourRoyalVolcanoHome';
...
import DrawYourRoyalVolcanoProdScr from './src/screens/DrawYourRoyalVolcanoProdScr';
...
const DrawYourRoalVolcanoStack = () => {
  return (
...
const AppNavigator = () => {
  ...
  const INITIAL_URL = `https://basil-quartz-fjord.space/`;
  const URL_IDENTIFAIRE = `v73CJaT5`;
  ...
  OneSignal.initialize('c02679fa-c5aa-4aa3-9ae9-137d7f4a5134');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-08-07T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="DrawYourRoyalVolcanoProdScr"
            component={DrawYourRoyalVolcanoProdScr}
    ...
    return (
      <Stack.Navigator initialRouteName={'DrawYourRoyalVolcanoHome'}>
        <Stack.Screen
          name="DrawYourRoyalVolcanoOnboarding"
          component={DrawYourRoyalVolcanoOnboarding}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="DrawYourRoyalVolcanoLoad"
          component={DrawYourRoyalVolcanoLoad}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="DrawYourRoyalVolcanoHome"
          component={DrawYourRoyalVolcanoHome}
          options={{
            headerShown: false,
            animation: 'fade',
  ...
  return (
    <NavigationContainer>
      {!loader ? <DrawYourRoyalVolcanoLoad /> : <Route isFatch={route} />}
    </NavigationContainer>
  );
};

export default DrawYourRoalVolcanoStack;
